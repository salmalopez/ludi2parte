...
public class PreguntasCuestionario4 {
    ...
    public PreguntasCuestionario4[] getPreguntas(){
        ...
        p1.pregunta = "1) ¿Cuál es el objetivo principal del plato del bien comer?";
        p1.correcta = 1;
        ...
        p2.pregunta = "2) ¿Cuantos grupos de alimentos existen en el plato del buen comer?";
        p2.correcta = 0;
        ...
        p3.pregunta = "3) ¿Cuáles son los colores utilizados en el Plato del Buen comer?";
        p3.correcta = 1;
        ...
        p4.pregunta = "4) Dentro del Plato del bien comer, se indica que los cereales y los alimentos de origen animal deben combinarse en la alimentación.";
        p4.correcta = 1;
        ...
        p5.pregunta = "5) ¿Cuáles son los alimentos que más se deben incluir en la alimentación?";
        p5.correcta = 2;
        ...
        p6.pregunta = "6) Si los alimentos de cada grupo guardan una correcta proporción entre sí, tu alimentación será:";
        p6.correcta = 1;
        ...
        p7.pregunta = "7) Al incluir un alimento de cada grupo dentro de las 3 comidas se lograra que estas sean completas.";
        p7.correcta = 0;
        ...
        p8.pregunta = "8) Dentro de tu plato, el 50% de el debe estar contenido de:";
        p8.correcta = 0;
        ...
        p9.pregunta = "9) ¿Qué significa que tu alimentación debe ser inocua?";
        p9.correcta = 2;
        ...
        p10.pregunta = "10) Dentro de tu plato, el 25% debe estar incluido de leguminosas y alimentos de origen animal.";
        p10.correcta = 0;
