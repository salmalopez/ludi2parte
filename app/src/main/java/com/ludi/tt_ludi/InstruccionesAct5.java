...
public class InstruccionesAct5 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instrucciones_act5);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        botonsonido = MediaPlayer.create(InstruccionesAct5.this, R.raw.regreso);
        botonsalida = MediaPlayer.create(InstruccionesAct5.this, R.raw.inicio);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case (R.id.btn_ra):
                botonsonido.start();
                Intent siguiente = new Intent(InstruccionesAct5.this, Libro.class);
                InstruccionesAct5.this.startActivity(siguiente);
                break;

            case (R.id.btn_comenzar):
                botonsonido.start();
                Intent intentAct2 = new Intent(InstruccionesAct5.this, Ahorcado.class);
