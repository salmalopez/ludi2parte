...
public class Libro extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btncancion = MediaPlayer.create(Libro.this, R.raw.cancion);

        architectView = (ArchitectView)findViewById(R.id.architectView);
        final StartupConfiguration configuration = new StartupConfiguration(WIKITUDE_SDK_KEY, StartupConfiguration.Features.Tracking2D,
